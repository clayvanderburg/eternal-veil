...
const StylePresets = {
    breathSanctuary: {
        ...
        desc: "A calm lotus field with two opposing orbs rocking together along the rim.",
    ...
    ethereal: {
        name: "Ethereal Aura",
        desc: "Lavender and indigo ribbons wander through a 6-fold kaleidoscope.",
        speed: 0.20,
        turbulence: 0.35,
        curl: 0.92,
        density: 1400,
    ...
    celticCurrent: {
        name: "Celtic Current",
        desc: "Two luminous woven currents turn, gently flex, and breathe independently through layered depth.",
        speed: 0.50,
        turbulence: 0.08,
        curl: 0.98,
        density: 1500,
    ...
    celticKnotwork: {
        ...
        rotationSpeed: 0.075,
        wobble: 0.13,
        colors: ["#06b6d4", "#67e8f9", "#14b8a6", "#a7f3d0", "#8b5cf6", "#c4b5fd"],
        particleShape: "celticKnotwork",
        particleLighting: "glow",
        kaleidoscopeEnabled: false,
        psychedelicMode: false,
        morphingBg: false,
    ...
    cymaticResonance: {
        ...
        rotationSpeed: 0.03,
        wobble: 0.14,
        colors: ["#fde68a", "#fbbf24", "#f472b6", "#c084fc", "#38bdf8", "#5eead4"],
        particleShape: "cymaticResonance",
        particleLighting: "glow",
        kaleidoscopeEnabled: false,
        psychedelicMode: false,
        morphingBg: false,
    ...
    vortex: {
        ...
        desc: "Loose violet currents with a second wavy spiral riding alongside.",
        speed: 0.80,
        turbulence: 0.28,
        curl: 0.95,
        density: 2000,
