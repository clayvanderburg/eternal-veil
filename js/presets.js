...
const StylePresets = {
    breathSanctuary: {
        ...
        desc: "A spacious lotus field with hypnotic opposing pendulum orbs rocking in an arc along the perimeter.",
    ...
    ethereal: {
        name: "Ethereal Aura",
        desc: "Lavender and indigo ribbons weave through a 6-mandala kaleidoscope.",
        speed: 0.20,
        turbulence: 0.35,
        curl: 0.92,
        density: 1400,
    ...
    cosmic: {
        name: "Nebula Spark",
        desc: "Puffing cosmic nebula clouds expand, ignite into brilliant star-sparks, and gently disperse.",
        speed: 0.90,
        turbulence: 0.45,
        curl: 0.92,
        density: 2600,
        ...
        particleShape: "nebulaSpark"
    },
    supernova: {
        name: "Solar Flare",
        desc: "Eclipsed black suns blaze with incandescent gold coronas and twisting magnetic plasma loops.",
        speed: 0.95,
        turbulence: 0.65,
        curl: 0.55,
        density: 1800,
    ...
    vortex: {
        ...
        desc: "A deep violet vortex entwined with a secondary harmonic wavy cyan spiral current.",
        speed: 0.85,
        turbulence: 0.30,
        curl: 0.96,
        density: 2200,
    ...
    strings: {
        name: "Cosmic Strings",
        desc: "Ultra-fine glowing cosmic strings weave a dense, vibrational web of harmonic light.",
        speed: 1.10,
        turbulence: 0.35,
        curl: 0.94,
        density: 3200,
        ...
        particleShape: "cosmicStrings",
        kaleidoscopeEnabled: true,
        kaleidoscopeSegments: 8
    },
    hypno: {
        name: "Hypnotic Spiral",
        desc: "A tightly coiled hypnotic spiral with synchronized pendulum orbs rocking along its curve.",
        speed: 0.22,
        turbulence: 0.01,
        curl: 0.96,
        density: 1100,
