...
const StylePresets = {
    ...
    liquid: {
        name: "Jade Currents",
        desc: "Undulating deep jade transverse waves roll beneath wandering teal and emerald brushstrokes.",
        speed: 0.50,
        turbulence: 0.35,
        curl: 0.98,
        density: 1100,
        ...
        particleShape: "jadeCurrents"
    },
    quantum: {
        name: "Quantum Drift",
        desc: "Entangled quantum wave packets hover in probability clouds before tunneling along laser-like filaments.",
        speed: 0.85,
        turbulence: 1.20,
        curl: 0.35,
        density: 2800,
    ...
    mandala: {
        name: "Prism Drift",
        desc: "Crystalline geometric prisms and diamond facets tumble, scale, and weave in semi-3D space.",
        speed: 0.40,
        turbulence: 0.15,
        curl: 0.92,
        density: 1200,
    ...
    paintedDepthSpiral: {
        name: "Painted Depth Spiral",
        desc: "A deep painterly spiral where soft luminous daubs drift in front of and behind one another.",
        speed: 0.48,
        turbulence: 0.035,
        curl: 0.98,
        density: 1050,
        ...
        rotationSpeed: 0,
        wobble: 0.02,
        colors: ["#064e3b", "#0f766e", "#14b8a6", "#22c55e", "#67e8f9", "#d1fae5"],
        psychedelicMode: false,
        morphingBg: false,
        spinningKaleido: false,
        particleShape: "painterlyVortex",
