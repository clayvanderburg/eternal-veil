...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function applyRandomConfig() {
        ...
        if (nextShape === "pendulumSpiral") {
            ...
            Object.assign(randomSettings, {
                speed: rnd(0.38, 0.62), turbulence: rnd(0.02, 0.10), density: rndInt(1300, 2200),
                flowOrganic: rnd(0.9, 1.05), dissipation: rnd(0.16, 0.26), zoom: rnd(0.95, 1.06),
                baseSize: rnd(1.8, 2.8), sizeVariation: rnd(0.3, 0.8), stretch: rnd(0.6, 1.6), interaction: 0,
                rotationSpeed: rnd(0.015, 0.05), wobble: rnd(0.08, 0.2), kaleidoscopeEnabled: false,
                psychedelicMode: false, morphingBg: false, spinningKaleido: false, particleLighting: "glow"
            });
    ...
    function randomizeAllParameters() {
        ...
        if (["pendulumSpiral", "painterlyVortex", "chromeRibbon", "celticCurrent", "celticKnotwork", "cymaticResonance", "tightTailVortex", "zenMandala", "quantumLattice", "gravityWell", "fractalBloom"].includes(nextPatternShape)) {
            const authoredTargets = nextPatternShape === "chromeRibbon" ? {
                ...
                speed: rnd(0.38, 0.62), turbulence: rnd(0.02, 0.10), density: Math.round(rnd(1300, 2200)),
                flowOrganic: rnd(0.9, 1.05), dissipation: rnd(0.16, 0.26), zoom: rnd(0.95, 1.06),
                baseSize: rnd(1.8, 2.8), sizeVariation: rnd(0.3, 0.8), stretch: rnd(0.6, 1.6), interaction: 0,
                rotationSpeed: rnd(0.015, 0.05), wobble: rnd(0.08, 0.2), drag: 0.93
            ...
            if (isFlowEnabled("kaleidoscopeEnabled")) {
                sim.settings.kaleidoscopeEnabled = false;
                elements.kaleidoscopeToggle.checked = false;
                elements.kaleidoscopeSettings.classList.add("hidden");
            }
            ["psychedelicMode", "morphingBg", "spinningKaleido"].forEach(key => {
                if (isFlowEnabled(key)) sim.settings[key] = false;
            });
