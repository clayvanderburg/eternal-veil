...
for (const shape of [
    ...
    'jadeCurrents', 'celticCurrent', 'quantumDrift', 'prismDrift', 'nebulaSpark', 'solarFlare', 'violetUndertow'
]) {
...
for (const shape of ['tightTailVortex', 'zenMandala', 'quantumLattice', 'gravityWell', 'fractalBloom', 'chromeRibbon', 'celticCurrent']) {
